...
def getInfosLive(dataDB, comp):
    ...
    for m in dataDB:
        ...
        if not noAffiche:
            dataArray.append((homeTeam, awayTeam, idTeam1, idTeam2, scoreHome, awayScore, timeMatch))
...
def live(request, comp):
    ...
    if comp == 'all':
        ...
        for cp in dictNameLeague.keys():
            ...
            dataMatchs += getInfosLive(data, cp)
    else:        
        ...
        dataMatchs += getInfosLive(data, comp)
